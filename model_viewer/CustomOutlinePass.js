import { Pass } from "https://cdn.jsdelivr.net/npm/three@0.121.1/examples/jsm/postprocessing/Pass.js";
  ...
  createOutlinePostProcessMaterial() {
    return new THREE.ShaderMaterial({
      uniforms: {
        ...
        depthBuffer: {},
        normalBuffer: {},
        outlineColor: { value: new THREE.Color(0x00000) },
        //4 scalar values packed in one uniform: depth multiplier, depth bias, and same for normals.
        multiplierParameters: { value: new THREE.Vector4(1, 1, 1, .7) },
